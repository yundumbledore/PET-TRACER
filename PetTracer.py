...
def plot_posterior(title, parameter_name, cm, abc=None, xl = None, xr = None):
    ...
    plt.xlabel(parameter_name,fontsize=14,fontname="Arial", fontweight='bold', labelpad=10)
    plt.ylabel('Density', fontsize=14,fontname="Arial", fontweight='bold', labelpad=10)
